...
//   const reopnseRecipesByCategory = async () => {
...
//     else if (selectedCategory !== "all") return reopnseRecipesByCategory()
//     else return responseRecipes()
//   },
//   staleTime: 1000 * 60,
//   enabled: !!debouncedSearchQuery || selectedCategory !== "all" || currentPage > 0,
// })
...
//     const delta = 1 // số trang hiển thị trước & sau currentPage
//     const pages: number[] = []

//     let start = Math.max(1, currentPage - delta)
//     let end = Math.min(totalPages, currentPage + delta)

//     // đảm bảo luôn có 3 nút nếu còn trang
//     if (end - start < 2) {
...
//                       className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground hover:cursor-pointer"
//                     />
//                   <Input
...
//             Hiển thị {recipes.length} trong tổng số {recipes.length} công thức
//           </p>
//         </div>
